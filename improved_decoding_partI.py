...
if __name__ == "__main__":
    ...
    prev_job_proc_times = torch.rand(1, 10, 1)
    prev_job_proc_energy = torch.rand(1, 10, 1)
    prev_job_proc_times_high_mode = prev_job_proc_times * 0.7
    prev_job_proc_energy_high_mode = prev_job_proc_energy * 1.5
    
    prev_job_feat = torch.cat((prev_job_proc_times, prev_job_proc_energy, prev_job_proc_times_high_mode, prev_job_proc_energy_high_mode), dim=-1) # (1, 10, 4)
    ...
    di_vector = decoder(prev_job_feat, ptr_h_state, ptr_c_state, num_machines_scalar)
